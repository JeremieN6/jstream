...
class PictureService{
    ...
    public function add(UploadedFile $picture, ?string $folder = '', ?int $width = 150, ?int $height = 250)
    {
        ...
        $path = $this->params->get('images_profil_directory') . $folder;
    ...
    public function delete(string $fichier, ?string $folder = '', ?int $width = 150, ?int $height = 250)
    {
